    ...
    <UserContextProvider>
      ...
      <Router>
        ...
        <Routes>
          ...
          <Route
            exact
            path="/plate-numbers-search"
            element={<PlateNumbersSearch />}
          />
          ...
          <Route
            exact
            path="/user-profile"
            element={<UserRoutes Component={UserProfile} />}
          />
          <Route
            exact
            path="/new-ads"
            element={<UserRoutes Component={NewAds} />}
          />
          <Route
            exact
            path="/manage-ads"
            element={<AdminModeratorRoutes Component={ManageAds} />}
          />
          <Route
            exact
            path="/monitor-page"
            element={<AdminModeratorRoutes Component={MonitorPage} />}
          />
          ...
          <Route
            exact
            path={`/ads-edit/:Id`}
            element={<UserRoutes Component={AdsEdit} />}
          />
        </Routes>
        <Footer />
      </Router>
