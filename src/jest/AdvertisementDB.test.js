...
test("Create a Car Advertisement : ", async () => {
	let advetise_info =new Car("My Car","Car Description",1200,{city:"Delhi"},owner,"",Advertisement_Types.Cars,2,1,4,10,["fine","excellent"],"Grey",2016,true,1,true,98701,1,40000,"Metalic",7653636,4,1400);
...
test("Fetch Single  Advertisement By  id: ", async () => {
